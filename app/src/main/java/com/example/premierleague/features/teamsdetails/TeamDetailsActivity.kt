...
class TeamDetailsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initAdapter()
        observe()
        val teamId = intent.extras!!.getInt(Constants.TEAM_ID_KEY)
        viewModel.getTeam(teamId)
    }

    private fun initAdapter() {
        playersAdapter = PlayersListAdapter(mutableListOf())
    ...
    private fun bindViews() {
        ...
        playersAdapter.players = team.players.toMutableList()
